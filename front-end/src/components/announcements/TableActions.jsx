            ...
            <div className="flex flex-wrap items-center gap-2 max-md:flex-col max-md:items-end">
                <div className="relative max-md:w-full">
                    ...
                    <input
                        ...
                        className="w-64 max-md:w-full rounded-full border border-slate-200 bg-white py-2 pl-9 pr-4 text-sm text-slate-600 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                    />
                </div>
